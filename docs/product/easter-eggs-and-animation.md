...
2. All four special cards are present: ship, Lrrr, Nibbler, and coffee trigger a delivery storm.
...
7. Matching numeric consensus: random consensus GIF, including Hypnotoad.
...
- Keyboard delivery storm: while joined to a chaotic room, press `Up`, `Down`, `Left`, `Right`, `A`, `B`, `Up`, `Down` within 4 seconds.
