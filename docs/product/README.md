...
- [domain-concepts.md](domain-concepts.md): core concepts and product rules
- [easter-eggs-and-animation.md](easter-eggs-and-animation.md): fun reaction triggers, priority, and special-card display rules
