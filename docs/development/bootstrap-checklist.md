...
| Automated PR review             | Present  | `.coderabbit.yaml`, `docs/development/safeguards.md`, `docs/deployment/fork-setup.md`                             | CodeRabbit is optional for forks and must be installed under fork-owned GitHub resources.   |
